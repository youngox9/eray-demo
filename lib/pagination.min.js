        ...
        var j = b(this),
            ...
            l = {
                ...
                generatePageNumbersHTML: function (a) {
                    ...
                    if (null === k.pageRange) {
                        for (b = 1; b <= e; b++) h += b == d ? '<li class="' + l + "-page J-paginationjs-page " + m + '" data-num="' + b + '"><a>' + b + "</a></li>" : '<li class="' + l + 'J-paginationjs-page" data-num="' + b + '"><a href="' + i + '">' + b + "</a></li>";
                        return h
                    }
                    if (f <= 3)
                        for (b = 1; b < f; b++) h += b == d ? '<li class="' + l + "-page J-paginationjs-page " + m + '" data-num="' + b + '"><a>' + b + "</a></li>" : '<li class="' + l + 'J-paginationjs-page" data-num="' + b + '"><a href="' + i + '">' + b + "</a></li>";
                    ...
                    for (b = f; b <= g; b++) h += b == d ? '<li class="' + l + "-page J-paginationjs-page " + m + '" data-num="' + b + '"><a>' + b + "</a></li>" : '<li class="' + l + 'J-paginationjs-page" data-num="' + b + '"><a href="' + i + '">' + b + "</a></li>";
                    if (g >= e - 2)
                        for (b = g + 1; b <= e; b++) h += '<li class="' + l + 'J-paginationjs-page" data-num="' + b + '"><a href="' + i + '">' + b + "</a></li>";
